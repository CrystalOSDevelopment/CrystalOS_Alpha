    ...
    class Window : App
    {
        ...
        public void App()
        {
            ...
            if (once == true)
            {
                ...
                canvas = ImprovedVBE.DrawImageAlpha2(canvas, x, y, canvas, Color.FromArgb(CurrentColor).R, Color.FromArgb(CurrentColor).G, Color.FromArgb(CurrentColor).B);
                ...
                foreach (var button in Button)
                {
                    if (button.Clicked == true)
                    {
                        ...
                        {
                            case "OK":
                                Graphics.TaskScheduler.Apps.Remove(this);
                                break;
                        }
                    }
                    else
