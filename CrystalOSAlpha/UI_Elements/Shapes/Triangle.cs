...
{
    public class Triangle : UIElementHandler
    {
        public Triangle(int Color, List<Point> Points, bool Visible, bool Filled, string ID)
        {
            this.Color = Color;
            this.ID = ID;
            this.Points = Points;
            this.Visible = Visible;
            this.TypeOfElement = TypeOfElement.Triangle;
        ...
        public void Render(Bitmap Canvas)
        {
            if (Visible)
            {
                if (!Filled)
                {
                    ImprovedVBE.DrawTriangle(Canvas, Points, Color);
                }
                else
                {
                    ImprovedVBE.DrawFilledTriangle(Canvas, Points, Color);
                }
            }
        }
