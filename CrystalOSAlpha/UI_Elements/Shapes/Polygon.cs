...
{
    public class Polygon : UIElementHandler
    {
        public Polygon(int Color, List<Point> Points, bool Visible, bool Filled, string ID)
        {
            this.Color = Color;
            this.ID = ID;
            this.Points = Points;
            this.Visible = Visible;
            this.TypeOfElement = TypeOfElement.Polygon;
            this.Filled = Filled;
        ...
        public void Render(Bitmap Canvas)
        {
            if (Visible)
            {
                if (Filled)
                {
                    ImprovedVBE.DrawFilledPollygon(Canvas, Points, Color);
                }
                else
                {
                    ImprovedVBE.DrawPollygonFrame(Canvas, Points, Color);
                }
            }
        }
