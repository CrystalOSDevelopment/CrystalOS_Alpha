...
namespace CSystem.Text.RegularExpressions
{
    ...
    internal class StringCharacterIterator : ICharacterIterator
    {
        ...
        {
            return _src.Substring(beginIndex, endIndex - beginIndex);
        ...
        {
            return _src.Substring(beginIndex);
        }
        ...
        /// <returns>true if the specified index is past the end of the character stream</returns>
        public bool IsEnd(int pos)
        {
            return (pos >= _srcLength);
        }
    }
